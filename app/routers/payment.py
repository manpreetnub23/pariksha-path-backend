...
async def create_order(
    ...
    try:
        print(current_user)
        # print("request is : ",request.amount, type(request.amount))
        # print("request is : ",request.currency , type(request.currency))
        # print("request is : ",request.course_id , type(request.course_id))
        # print("CURRENT USER is : ",current_user.id , type(current_user.id))
        # print(int(time.time()))
        order = razorpay_client.order.create(
            {
                # "amount": 100,
                # "currency": "INR",
                # "receipt": "dniehiua328rdinrerhw98i3kh",
                # "payment_capture": 1,
